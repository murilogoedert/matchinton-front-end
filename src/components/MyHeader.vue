...
<template>
    <div id="mainHeader" @mouseleave="menuSuspenso = false">
        ...
        <div id="icons">
            ...
            <span id="nome-user" class="text-md-center tex" @mouseover="menuSuspenso = true">Olá {{
                userStore.getUser().value?.name }}</span>
        ...
        <div id="menuSuspenso" v-if="menuSuspenso">
            ...
            <Router-link to="/requests">
                <div class="itemMenuSuspenso">
                    <Icon icon="material-symbols:mark-email-unread" class="menuIcon" />
